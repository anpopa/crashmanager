...
static GSourceFuncs elogsrv_source_funcs = {
  elogsrv_source_prepare, NULL, elogsrv_source_dispatch, NULL, NULL, NULL,
};
...
cdm_elogsrv_new (CdmOptions *options, CdmJournal *journal, GError **error)
{
  ...
  g_source_set_callback (CDM_EVENT_SOURCE (elogsrv), G_SOURCE_FUNC (elogsrv_source_callback),
