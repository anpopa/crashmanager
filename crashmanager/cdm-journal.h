...
#define CDM_JOURNAL_EPILOG_MAX_BT (CDM_MESSAGE_EPILOG_FRAME_MAX_LEN * \
                                   CDM_MESSAGE_EPILOG_FRAME_MAX_CNT)
 ...
 */
void                    cdm_journal_epilog_add              (CdmJournal *journal, 
                                                             CdmJournalEpilog *elog);
 ...
 */
CdmJournalEpilog *      cdm_journal_epilog_get              (CdmJournal *journal, 
                                                             int64_t pid);
 ...
 */
gboolean                cdm_journal_archive_exist           (CdmJournal *journal, 
 ...
 */
gssize                  cdm_journal_get_data_size           (CdmJournal *journal, 
                                                             GError **error);
 ...
 */
gssize                  cdm_journal_get_entry_count         (CdmJournal *journal, 
                                                             GError **error);
 ...
 */
gchar *                 cdm_journal_get_untransferred       (CdmJournal *journal, 
                                                             GError **error);
 ...
 * returned. If an error occured the error is set and NULL is returned.
 */
gchar *                 cdm_journal_get_victim              (CdmJournal *journal, 
                                                             GError **error);
