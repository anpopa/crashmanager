 ...
 */
CdmMessage *            cdm_message_new                    (CdmMessageType type,
                                                            uint16_t session);
 ...
 */
void                    cdm_message_set_epilog_frame_count  (CdmMessage *msg,
 ...
 */
void                    cdm_message_set_epilog_frame_data   (CdmMessage *msg,
                                                            const gchar *frame_data);
 ...
 */
void                    cdm_message_set_lifecycle_state     (CdmMessage *msg,
 ...
 */
void                    cdm_message_set_context_name        (CdmMessage *msg,
 ...
 */
void                    cdm_message_set_process_pid         (CdmMessage *msg,
                                                             int64_t pid);
 ...
 */
void                    cdm_message_set_process_exit_signal (CdmMessage *msg,
                                                             int64_t process_signal);
 ...
 */
void                    cdm_message_set_process_timestamp   (CdmMessage *msg,
                                                             uint64_t timestamp);
 ...
 */
void                    cdm_message_set_process_name        (CdmMessage *msg,
                                                            const gchar *name);
 ...
 */
void                    cdm_message_set_thread_name         (CdmMessage *msg,
 ...
 */
void                    cdm_message_set_process_crash_id    (CdmMessage *msg,
                                                             const gchar *crashid);
 ...
 */
void                    cdm_message_set_process_vector_id   (CdmMessage *msg,
 ...
 */
void                    cdm_message_set_process_context_id  (CdmMessage *msg,
 ...
 */
void                    cdm_message_set_coredump_file_path  (CdmMessage *msg,
                                                             const gchar *fpath);
 ...
 */
CdmStatus               cdm_message_read                    (gint fd,
                                                             CdmMessage *msg);
 ...
 * @return CDM_STATUS_OK on success, CDM_STATUS_ERROR otherwise
 */
CdmStatus               cdm_message_write                   (gint fd,
                                                             CdmMessage *msg);
