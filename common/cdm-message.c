...
cdm_message_write (gint fd, CdmMessage *msg)
{
  ...
  switch (cdm_message_get_type (msg))
    ...
    case CDM_MESSAGE_COREDUMP_NEW:
      ...
      msg->hdr.size_of_arg4 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.process_name,
                                                                  CDM_MESSAGE_PROCNAME_MAX_LEN
                                                                  + 1));
      msg->hdr.size_of_arg5 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.thread_name,
                                                                  CDM_MESSAGE_THREDNAME_MAX_LEN
                                                                  + 1));
      break;

    case CDM_MESSAGE_COREDUMP_UPDATE:
      msg->hdr.size_of_arg1 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.process_crash_id,
                                                                  CDM_MESSAGE_CRASHID_MAX_LEN
                                                                  + 1));
      msg->hdr.size_of_arg2 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.process_vector_id,
                                                                  CDM_MESSAGE_CRASHID_MAX_LEN
                                                                  + 1));
      msg->hdr.size_of_arg3 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.process_context_id,
                                                                  CDM_MESSAGE_CRASHID_MAX_LEN
                                                                  + 1));
      break;

    case CDM_MESSAGE_COREDUMP_SUCCESS:
      msg->hdr.size_of_arg1 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.coredump_file_path,
                                                                  CDM_MESSAGE_FILENAME_MAX_LEN
                                                                  + 1));
      msg->hdr.size_of_arg2 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.context_name,
                                                                  CDM_MESSAGE_CTXNAME_MAX_LEN
                                                                  + 1));
      msg->hdr.size_of_arg3 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.lifecycle_state,
                                                                  CDM_MESSAGE_LCSTATE_MAX_LEN
                                                                  + 1));
      break;
    ...
    case CDM_MESSAGE_COREDUMP_CONTEXT:
      msg->hdr.size_of_arg1 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.context_name,
                                                                  CDM_MESSAGE_CTXNAME_MAX_LEN
                                                                  + 1));
      msg->hdr.size_of_arg2 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.lifecycle_state,
                                                                  CDM_MESSAGE_LCSTATE_MAX_LEN
                                                                  + 1));
      break;
    ...
    case CDM_MESSAGE_EPILOG_FRAME_DATA:
      msg->hdr.size_of_arg1 = (uint16_t)(sizeof(gchar) * strnlen (msg->data.epilog_frame_data,
